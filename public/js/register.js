...
if (registerForm) {
    registerForm.addEventListener('submit', async (e) => {
        ...
        // ✅ CORRECTION : On envoie exactement ce que le Validator Laravel attend
        const userData = {
        ...
        try {
            // ✅ Utilise /api/register (chemin relatif plus sûr)
            ...
            if (response.ok) {
                ...
                const confirmBox = document.getElementById('register-confirmation');
                ...
                // ✅ Afficher l'erreur précise de Laravel
                let msg = "Erreur d'inscription";
                if (data.errors) {
                    // Récupère le premier message d'erreur s'il y en a
